...
def test_semantic_schema_rejects_markdown_missing_fields_wrong_types_and_enums(direct_vm, direct_deploy):
    ...
    invalid_candidates = [
        ...
        dict(valid, materiality="MATERIAL_REVOCATION"),
        dict(valid, materiality="MATERIAL_CHANGE"),
        dict(valid, materiality="material"),
        dict(valid, materiality=" MATERIAL "),
        dict(valid, materiality=None),
        dict(valid, materiality=True),
        dict(valid, materiality=1),
        dict(valid, materiality="UNKNOWN"),
